...
insert  into `advert`(`id`,`count`,`creationDateTime`,`description`,`expirationDateTime`,`image`,`title`,`url`) values (1,NULL,NULL,'long sleeves',NULL,'resources/img/adverts/5be8da29-cd51-4b56-8ef2-5e16a927027a.jpg','banner1','banner.com');
insert  into `advert`(`id`,`count`,`creationDateTime`,`description`,`expirationDateTime`,`image`,`title`,`url`) values (2,NULL,NULL,'women clothing',NULL,'resources/img/adverts/5daab05d-dd51-43f8-9f36-b84fef1a3377.jpg','banner2','banner2.com');
...
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (1,100,'V-neck, knee-length dress in airy chiffon with details on shoulders. Cap sleeves, buttons at front, and elastication at back of waist. Attached tie belt. Satin lining','resources/img/product/beltdress.jpg','Dress with Tie Belt',34.99,1,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (2,100,'Short, gently fitted bib overall dress in woven fabric. Buttons at front, wide, adjustable shoulder straps, and a seam at waist','resources/img/product/overalldress.jpg','Bib Overall Dress',34.99,1,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (3,100,'Calf-length dress in airy, woven fabric with a printed pattern. Jersey liner dress','resources/img/product/patterneddress.jpg','Patterned Dress',39.99,1,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (4,100,'Sleeveless, calf-length wrap dress in airy, woven plumeti fabric. Narrow, adjustable shoulder straps and seam below bust with ties','resources/img/product/wrapdress.jpg','Pleated Wrap Dress',79.99,1,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (5,100,'Sleeveless shirt dress in woven viscose fabric with a collar, buttons at front, and removable tie belt at waist. Gently rounded hem.','resources/img/product/shirtdress.jpg','Sleeveless Shirt Dress',17.99,1,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (6,100,'Short, sleeveless dress in lace with scalloped edges. V-neck, adjustable, extra-narrow shoulder straps, and a concealed zip at back. Gently flared skirt','resources/img/product/vneckdress.jpg','Lace V-neck Dress',59.99,1,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (7,100,'Ankle-length jeans in washed stretch denim with a regular waist. Mock front pockets, regular back pockets, and skinny legs','resources/img/product/skinnyjeans.jpg','Skinny Regular Ankle Jeans',9.99,4,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (8,100,'5-pocket jeans in washed denim with a regular waist, zip fly, and slim legs','resources/img/product/slimjeans.jpg','Slim Jeans',19.99,4,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (9,100,'Shirt in woven cotton-blend fabric. Regular Fit – classic fit with good room for movement and gently shaped waist for a comfortable, tailored silhouette','resources/img/product/fitshirt.jpg','Regular Fit Henley Shirt',24.99,2,1);
insert  into `product`(`id`,`available`,`description`,`image`,`name`,`price`,`category_id`,`seller_id`) values (10,100,'Single-breasted blazer in woven stretch fabric with narrow, notched lapels. Super skinny fit – slightly shorter style, shaped at chest, tapered sharply at waist, combined with narrow shoulders and sleeves for a completely tailored silhouette','resources/img/product/fitblazer.jpg','Super Skinny Fit Blazer',19.99,3,1);

/*Data for the table `seller` */

insert  into `seller`(`id`,`description`,`name`,`picture`,`status`,`user_id`) values (1,'Phoenix offers fashion and quality at the best price','Phoenix','resources/img/shop/4a8ed458-a506-4e36-87f0-67b1614a2eeb.jpg','APPROVED',2);
insert  into `seller`(`id`,`description`,`name`,`picture`,`status`,`user_id`) values (2,'Blue Sand offers fashion and quality at the best price','Blue Sand','resources/img/shop/bluesand-fashion-shop.jpg','PENDING',6);
insert  into `seller`(`id`,`description`,`name`,`picture`,`status`,`user_id`) values (3,'Fashion Shop offers fashion and quality at the best price','Fashion Shop','resources/img/shop/3D-Fashion-Shop-11-Model-Free-Download-3.jpg','PENDING',7);

/*Data for the table `user` */

insert  into `user`(`id`,`address`,`avatar`,`email`,`firstName`,`lastName`,`password`,`phone`,`registerDate`,`role`) values (1,'1000 N 4th St, Fairfield, IA','resources/img/avatar/buyer.jpg','buyer@shopping.com','First','Buyer','$2a$10$b.9CsDYMBdFIMB5ja.lg0.3/OHFiv5kMn7yR.FKCZY3JScMRPvE.G','123-456-7890','2019-09-24','BUYER');
insert  into `user`(`id`,`address`,`avatar`,`email`,`firstName`,`lastName`,`password`,`phone`,`registerDate`,`role`) values (2,'1000 N 4th St, Fairfield, IA','resources/img/avatar/seller.png','seller@shopping.com','First','Seller','$2a$10$13wR9hYkIwBP0WIT525/XO23UfTvtjUKjbHCLlwAzYNzF3IkBlZRy','123-456-7890','2019-09-24','SELLER');
insert  into `user`(`id`,`address`,`avatar`,`email`,`firstName`,`lastName`,`password`,`phone`,`registerDate`,`role`) values (3,'1000 N 4th St, Fairfield, IA','resources/img/avatar/admin.png','admin@shopping.com','Shopping','Admin','$2a$10$HM.MYd2XpX7VEsNoZMTUmer6X7MZ7/semLLQ/bDqdsrbhn5EeRO3y','000-000-0000','2019-09-24','ADMIN');
